...
class TransaksiTokoController extends GetxController {
  final keranjang = TokoTransaksiModel().obs;
...
class TransaksiTokoPage extends StatelessWidget {
  final controller = Get.put(TransaksiTokoController());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          BlocProvider<TokoBarangBloc>(
            create: (context) =>
                TokoBarangBloc()..add(TokoBarangGetListEvent()),
            child: TransaksiTokoView(),
          ),
          Positioned(
              bottom: 0.03.sh,
              right: 0.1.sw,
...
class TransaksiTokoView extends StatelessWidget {
                    ...
                    return SmartRefresher(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          TokoBarangModel barang = stateData.tokoBarangs[index];
                          ...
                          return Parent(
                            gesture: Gestures()
                              ..onTap(() {
                                ...
                                int no = 0;
                                for (TokoBarangModel keranjangBarang
