...
class DashboardTokoController extends GetxController {
  final listIcon = [].obs;
  @override
  void onInit() async {
    listIcon.value = [
      {"title": "Transaksi", "icon": Icons.monetization_on, "onpress": 4},
      {"title": "Karyawan", "icon": Icons.group, "onpress": 7},
      {"title": "Barang", "icon": Icons.local_offer, "onpress": 3},
      {
        "title": "Tanggungan",
...
class DashboardTokoPage extends StatelessWidget {
  final controller = Get.put(DashboardTokoController());
