...
import 'package:wholesale/bloc/distributor/dashboard/distributordashboard_bloc.dart';
...
class DashboardDistributorController extends GetxController {
  final listIcon = [].obs;
  @override
  void onInit() async {
    listIcon.value = [
...
class DashboardDistributorPage extends StatelessWidget {
  final controller = Get.put(DashboardDistributorController());
          ...
          Positioned(
            ...
            child: Parent(
              child: Column(
                children: [
                  BlocProvider(
                    create: (context) => DistributorDashboardBloc()
                      ..add(DistributorDashboardGetEvent()),
                    child: BlocBuilder<DistributorDashboardBloc,
                        DistributorDashboardState>(
                      builder: (context, state) {
                        int keuntungan = 0;
                        int aset = 0;
                        if (state is DistributorDashboardStateSuccess) {
